...
func (c *Client) ReplaySend(ctx context.Context, opts ReplaySendOpts) (*protocol.ReplaySendResponse, error) {
	...
	if opts.StreamStrategy != "" {
		args["stream_strategy"] = opts.StreamStrategy
	}
...
// OastGet calls oast_get and returns event data, optionally filtered by fields.
func (c *Client) OastGet(ctx context.Context, eventID string, fields string) (*protocol.OastEvent, error) {
	args := map[string]interface{}{
		"event_id": eventID,
	}
	if fields != "" {
