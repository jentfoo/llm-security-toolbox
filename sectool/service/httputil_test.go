...
func TestPreviewBody(t *testing.T) {
	...
	tests := []struct {
		...
		{"utf8_truncate", []byte("hello world"), 7, "", "hell..."},
		...
		{"multibyte_truncate", []byte("hello\u4e16\u754c"), 6, "", "hel..."},
		{"emoji_truncate", []byte("test\U0001F389\U0001F38A\U0001F381"), 5, "", "te..."},
		{"cjk_only", []byte("\u65e5\u672c\u8a9e\u30c6\u30b9\u30c8"), 3, "", "..."},
