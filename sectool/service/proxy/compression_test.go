...
func TestFilterSupportedEncodings(t *testing.T) {
	...
	tests := []struct {
		...
		{"identity_preserved", "gzip, identity", "gzip, identity"},
		{"identity_unchanged", "identity", "identity"},
		{"identity_forbidden_alone", "identity;q=0", "identity;q=0"},
		{"identity_forbidden_with_gzip", "gzip, identity;q=0", "gzip, identity;q=0"},
		{"forbidden_strips_unsupported", "identity;q=0, snappy", "identity;q=0"},
		{"identity_low_q_kept", "identity;q=0.5", "identity;q=0.5"},
		{"gzip_q_zero_kept", "gzip;q=0", "gzip;q=0"},
