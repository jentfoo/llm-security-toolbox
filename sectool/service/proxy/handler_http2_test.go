...
func TestHistoryEntryFormatRequest(t *testing.T) {
	t.Parallel()

	t.Run("h2_request", func(t *testing.T) {
		entry := &HistoryEntry{
			Protocol: "h2",
	...
	t.Run("h2_nil_request", func(t *testing.T) {
		entry := &HistoryEntry{Protocol: "h2"}
		assert.Nil(t, entry.FormatRequest())
	})

	t.Run("http1_nil_request", func(t *testing.T) {
		entry := &HistoryEntry{Protocol: "http/1.1"}
		assert.Nil(t, entry.FormatRequest())
	})
}

func TestHistoryEntryFormatResponse(t *testing.T) {
	t.Parallel()

	t.Run("h2_response", func(t *testing.T) {
		entry := &HistoryEntry{
			Protocol: "h2",
	...
	t.Run("h2_nil_response", func(t *testing.T) {
		entry := &HistoryEntry{Protocol: "h2"}
		assert.Nil(t, entry.FormatResponse())
	})

	t.Run("http1_nil_response", func(t *testing.T) {
		entry := &HistoryEntry{Protocol: "http/1.1"}
		assert.Nil(t, entry.FormatResponse())
	})
...
func TestHistoryEntryGetMethods(t *testing.T) {
	...
	t.Run("http1_entry", func(t *testing.T) {
		entry := &HistoryEntry{
			Protocol: "http/1.1",
...
func TestHTTP2ProxyEndToEnd(t *testing.T) {
	...
	time.Sleep(100 * time.Millisecond) // TODO - avoid the need to sleep
